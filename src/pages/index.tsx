...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`InvoiSmart`}</title>

        <meta
          name="description"
          content="Welcome to InvoiSmart - Your trusted partner in streamlining billing and payment processes, enhancing efficiency, and improving user experience for small businesses across the United States."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-490a1ba16284?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWxsaW5nfGVufDB8fHx8MTY4OTk5OTkzNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to InvoiSmart - Your trusted partner in streamlining billing and payment processes, enhancing efficiency, and improving user experience for small businesses across the United States.`}
            </Text>
            <Box
